...
@Component({
    selector: 'app-listing-13',
    imports: [FancyBannerTwoComponent, Footer5Component, CommonModule, NgSelectModule, NgxSliderModule, Navbar6Component],
    templateUrl: './listing-13.component.html'
})
export class Listing13Component {
  ...
  bath = [
    { value: '1', label: 'Any' }, { value: '2', label: '3+' }, { value: '3', label: '4+' },
    { value: '4', label: '2+' }, { value: '6', label: '1+' }
  ];
  bed = [
    { value: '1', label: 'Any' }, { value: '2', label: '3+' }, { value: '3', label: '4+' },
    { value: '4', label: '2+' }, { value: '6', label: '1+' }
  ...
  year = [
    { value: '1', label: '2020' }, { value: '2', label: '2019' }, { value: '3', label: '2018' },
    { value: '4', label: '2017' }, { value: '6', label: '2016' }
  ];
  locations = [
